import{a as e,c as t,i as n,l as r,n as i,o as a,r as o,s,t as c}from"./riviera-three-CP64oXgg.js";var l=`/kite-schools-showcase/`;async function u(u){let d,f,p,m,h,g=0,_=!1,v=!0,y=!1,b=matchMedia(`(prefers-reduced-motion: reduce)`).matches;try{d=new c({alpha:!0,antialias:!1,powerPreference:`low-power`}),d.setPixelRatio(Math.min(window.devicePixelRatio,1.5)),d.outputColorSpace=e,u.append(d.domElement);let x=new a,S=new o(-1,1,1,-1,0,1);if(f=await new t().loadAsync(`${l}riviera-images/${u.dataset.image}.webp`),_){f.dispose();return}f.colorSpace=e;let C=new r(.5,.5),w=new r(.5,.5),T={uTexture:{value:f},uTime:{value:0},uPointer:{value:C},uAspect:{value:1},uImageAspect:{value:f.image.width/f.image.height},uActive:{value:+!b},uHover:{value:0},uFocus:{value:.5}};p=new s({uniforms:T,depthWrite:!1,depthTest:!1,vertexShader:`varying vec2 vUv;void main(){vUv=uv;gl_Position=vec4(position,1.);}`,fragmentShader:`
